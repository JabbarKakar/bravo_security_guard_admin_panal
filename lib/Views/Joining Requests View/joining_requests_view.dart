...
class JoiningRequestView extends StatefulWidget {
  const JoiningRequestView({Key? key}) : super(key: key);

  @override
  State<JoiningRequestView> createState() => _JoiningRequestViewState();
}

class _JoiningRequestViewState extends State<JoiningRequestView> {
